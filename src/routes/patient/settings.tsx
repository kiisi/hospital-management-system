                        ...
                        {[
                          ...
                          <div key={item.key} className="flex items-center justify-between py-2">
                            ...
                            <button
                              ...
                              className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors duration-200 flex-shrink-0 ${notificationSettings[item.key] ? 'bg-[#346ED6]' : 'bg-gray-200'
                                }`}
                            >
                              <span
                                className={`inline-block h-6 w-6 transform rounded-full bg-white shadow-sm transition-transform duration-200 ${notificationSettings[item.key] ? 'translate-x-[22px]' : 'translate-x-0.5'
                                  }`}
                              />
                            </button>
                          </div>
                      ...
                      <div className="space-y-4">
                        {[
                          ...
                          <div key={item.key} className="flex items-center justify-between py-2">
                            ...
                            <button
                              onClick={() => toggleNotification(item.key)}
                              className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors duration-200 flex-shrink-0 ${notificationSettings[item.key] ? 'bg-[#346ED6]' : 'bg-gray-300'
                                }`}
                            >
                              <span
                                className={`inline-block h-6 w-6 transform rounded-full bg-white shadow-sm transition-transform duration-200 ${notificationSettings[item.key] ? 'translate-x-[22px]' : 'translate-x-0.5'
