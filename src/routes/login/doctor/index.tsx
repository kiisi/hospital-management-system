...
export const loginDoctorSchema = Yup.object({
  email: Yup.string()
...
function RouteComponent() {
  ...
  const { data, mutate, isPending } = useMutation({
    mutationFn: (payload: LoginDoctorInput) => {
      return fetch("/login/doctor/", {
        method: "POST",
        headers: {
  ...
  const formik = useFormik<LoginDoctorInput>({
    initialValues: {
      email: "",
      password: "",
    },
    validationSchema: loginDoctorSchema,
