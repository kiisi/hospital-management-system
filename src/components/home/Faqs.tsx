...
const FAQ_ITEMS = [
  { q: "How do I book an appointment?", a: "Simply create an account, choose your preferred doctor or service, and select an available time slot that works for you." },
  { q: "Can I consult a doctor online?", a: "Yes. BlueCare offers secure virtual consultations, allowing you to connect with qualified healthcare professionals from anywhere." },
  { q: "Are my medical records secure?", a: "Absolutely. We use advanced security measures and encryption to protect your personal health information and medical records." },
  { q: "Can I access lab results through BlueCare?", a: "Yes. Lab test results are available within your patient portal, making it easy to view and manage your health information." },
  { q: "Is BlueCare available 24/7?", a: "Yes. Our platform provides round-the-clock access to healthcare services, appointment scheduling, and on-demand medical consultations." },
  { q: "Does BlueCare support prescription management?", a: "Yes. You can receive digital prescriptions from your healthcare provider and conveniently manage them through our platform." },
  { q: "Who can use BlueCare?", a: "BlueCare is designed for individuals, families, healthcare providers, employers, and insurance partners seeking accessible and quality healthcare services." },
];
            ...
            <div className="max-w-[720px] mx-auto px-6">
                ...
                >
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 border border-gray-200 mb-6">
                        ...
                        <span className="text-[13px] font-semibold text-gray-600 tracking-wide">FAQs</span>
                    </div>
